  ...
  $('.coins').append(`
    <div class="card border-light text-light bg-transparent ">
      ...
      <div class="card-footer bg-transparent ">
        <button type="button" class="btn btn-success moreInfo" data-bs-toggle="collapse" 
...
const checkBoxCont = () => {
  ...
  if (howMuch >= 6) {
    ...
    <div class="row">
    <div class="col-6">
      <h5 class="display-6 text-light">Live Report Coins</h5>
      <ul>
    ...
    <div class="col-6">
      <h5 class="display-6 text-light">The Extra Coin</h5>
      <ul>
